...
async def get_all_channels_from_site(page):
    ...
    print(f"[{now()}] >>> Стелс-сканирование...")
    try:
        # Увеличиваем таймаут и ждем именно загрузки контента
